...
const DriverMonthlyReports = () => {
  ...
  // Navigate back to the previous page using navigate
  const handleFinish = () => {
    navigate('/admin/AdminDashboard'); // Go back to the previous page
  };
        ...
        {reports.length > 0 ? (
          reports.map((report) => (
            <div key={report.driverId} className="report">
              ...
              {/* Example Link to a report details page */}
              <Link to={`/report-details/${report.driverId}`} className="link-button">
...
export default DriverMonthlyReports;
